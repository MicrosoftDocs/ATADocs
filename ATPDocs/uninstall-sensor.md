...
- [Uninstall the [!INCLUDE [Product short](includes/product-short.md)] sensor silently](silent-installation.md#uninstall-the-include-product-shortincludesproduct-shortmd-sensor-silently)
