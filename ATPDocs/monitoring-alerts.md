...
# Understanding Azure ATP monitoring alerts
...
|Alert|Description|Resolution|Severity|
|----|----|----|----|
|The Azure ATP Standalone Sensor is currently offline due to connectivity issues to all the configured domain controllers.|This impacts Azure ATP’s ability to detect suspicious activities related to domain controllers monitored by this Azure ATP Standalone Sensor.| Make sure the domain controllers are up and running and that this Azure ATP Standalone Sensor can open LDAP connections to them.|Medium|
