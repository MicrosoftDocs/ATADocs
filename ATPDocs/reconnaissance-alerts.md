...
The following security alerts help you identify and remediate **Reconnaissance** phase suspicious activities detected by Defender for Identity in your network.
...
1. Check if the source computer is a DNS server.
    ...
    - To prevent future **FPs**, verify that UDP port 53 is **open** between the Defender for Identity sensor and the source computer.
