...
The following security alerts help you identify and remediate **Reconnaissance** phase suspicious activities detected by Azure ATP in your network. In this tutorial, you'll learn how to understand, classify, remediate and prevent the following types of attacks:
...
3. Check which user(s) performed the operation.
    Is that user(s) supposed to perform those actions?  
...
1. Click on the source computer to go to its profile page.        
    ...
    If you answered **yes** to the questions above, *Close* the alert as a **B-TP** activity. 
