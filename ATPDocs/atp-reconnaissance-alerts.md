...
## Account enumeration reconnaissance  <a name="reconnaissance-using-account-enumeration"></a>
...
## Network mapping reconnaissance (DNS) <a name="reconnaissance-using-dns"></a>
...
## User and Group membership reconnaissance (SAMR)  <a name="reconnaissance-using-directory-service-queries"></a>
