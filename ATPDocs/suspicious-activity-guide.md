...
*Phases:*
- [1. Reconnaissance alerts](reconnaissance-alerts.md)
- [2. Compromised credential alerts](compromised-credential-alerts.md)
- [3. Lateral movement alerts](lateral-movement-alerts.md)
- [4. Domain dominance alerts](domain-dominance-alerts.md)
- [5. Exfiltration alerts](exfiltration-alerts.md)
