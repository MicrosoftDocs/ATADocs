...
To resolve IP addresses to computer names, Azure ATP sensors try to query the IP address for the computer name "behind" the IP, using all of the following methods:
...
\* Only of these methods is required, but we recommend configuring all of them.
