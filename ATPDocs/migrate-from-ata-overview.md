...
- Make sure your domain controllers meet all the [Azure ATP sensor requirements](prerequisites.md#azure-sensor-requirements) and your environment meets all [Azure ATP requirements](atp-prerequisites.md).
