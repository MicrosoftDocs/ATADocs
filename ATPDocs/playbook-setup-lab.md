...
1. An [Azure ATP instance](install-step1.md) that is [connected to AD](install-step2.md).
1. [Download](install-step3.md) and [install the latest version of the Azure ATP sensor](install-step4.md) on your lab's domain controller.
...
> [Azure ATP Reconnaissance playbook](playbook-reconnaissance.md)
