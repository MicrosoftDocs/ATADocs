...
|---------|---------|---------|
|**[Security principal reconnaissance (LDAP)](credential-access-alerts#security-principal-reconnaissance-ldap-external-id-2038)**     |    On *Medium* mode, this detection triggers immediately and disables the filtering of popular queries in the environment.         |   *High* mode includes everything in *Medium* mode, plus a lower threshold for queries, single scope enumeration, and more.     |
