...
> - This assessment might contain previously deleted entities if the [prerequisites](deploy/prerequisites.md) for Microsoft Defender for Identity are not met.
