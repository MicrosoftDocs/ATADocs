...
- Trusted root certiicates on your machine, especially if you're using a proxy. If your trusted root CA-signed certificates are missing, [you may recieve a connection error](../troubleshooting-known-issues#proxy-authentication-problem-presents-as-a-connection-error).
