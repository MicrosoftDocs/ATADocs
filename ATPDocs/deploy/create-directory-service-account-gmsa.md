...
>[!NOTE]
> If you haven't used gMSA accounts before, you may need to generate a new root key for the Microsoft Group Key Distribution Service (KdsSvc) within Active Directory. This step is required only once per forest.
>
