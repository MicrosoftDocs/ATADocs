...
- Verify that the servers you intend to install [!INCLUDE [Product short](includes/product-short.md)] sensors on are able to reach the [!INCLUDE [Product short](includes/product-short.md)] Cloud Service. They should be able to access https://**your-instance-name**sensorapi.atp.azure.com (port 443 tcp). For example, https://**contoso-corp**sensorapi.atp.azure.com.
