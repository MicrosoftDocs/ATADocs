...
Installation of the ATA Center as a virtual machine is supported. For more information see [configure port mirroring](/advanced-threat-analytics/plan-design/configure-port-mirroring).
...
The ATA Center requires a minimum of 21 days of data for user behavioral analytics. For more information on hardware requirements, see [ATA capacity planning](/advanced-threat-analytics/plan-design/ata-capacity-planning).
...
[ATA architecture](/advanced-threat-analytics/understand-explore/ata-architecture)
 [Install ATA](/advanced-threat-analytics/deploy-useinstall-ata)
