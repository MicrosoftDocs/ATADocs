...
title: Pre-install software for servers | Microsoft Advanced Threat Analytics
description: Steps for pre-installation of sofware on servers before installation.
keywords:
author: rkarlin
manager: stevenpo
ms.date: 04/28/2016
