...
## ATA Center Issues
### ATA Center running out of disk space
...
### ATA Gateway certificate about to expire
|Alert|Description|Resolution|Severity|
|----|----|----|----|
...
### ATA Gateway certificate expired
|Alert|Description|Resolution|Severity|
|----|----|----|----|
...
### All/Some of the capture network adapters on an ATA Gateway are not available
|Alert|Description|Resolution|Severity|
|----|----|----|----|
...
### Some domain controllers are unreachable by a ATA Gateway
|Alert|Description|Resolution|Severity|
|----|----|----|----|
...
### All domain controllers are unreachable by a ATA Gateway
|Alert|Description|Resolution|Severity|
|----|----|----|----|
...
### ATA Gateway service failed to start
|Alert|Description|Resolution|Severity|
|----|----|----|----|
...
## Lightweight Gateway
### Lightweight ATA Gateway reached a memory resource limit
|Alert|Description|Resolution|Severity|
|----|----|----|----|
