...
1. To avoid upgrade issues, make sure you follow steps 8 to 10 of [Migration failure when updating to ATA version 1.6](whats-new-version-1.6#Migration-failure-when-updating-from-ATA-1.5)
